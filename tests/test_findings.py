...
def test_rendered_text_is_member_only_and_masked():
    ...
    anon_raw = json.dumps(serialize_run(_run(), viewer=None), ensure_ascii=False)
    assert "공격 문구" not in anon_raw
